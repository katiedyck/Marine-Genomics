...
- Workshop 2: [Genome Assembly](code/genomics_workshop2.Rmd)
- Workshop 3: [Metagenome Assembly](code/workshop3_MetagenomeAssembly.Rmd)
- Workshop 4: [Black Band Disease (BBD)](code/workshop4_BBD.Rmd)

The [`styles.css`](code/styles.css) file, found in the 'code' folder, contains formatting for my Markdown files that shows terminal bash coding in a unique formatting, making it easier to distinguish from R coding.
